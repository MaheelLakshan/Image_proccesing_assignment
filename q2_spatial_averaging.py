...
# The function to perform spatial averaging on an image
def spatial_average(img_path, kernel_sizes):
    ...
    for kernel_size in kernel_sizes:
        ...
        # Save the image
        cv2.imwrite(f'images/output/question_2/average_image_{kernel_size}x{kernel_size}.jpg', avg_img)
    return


# Define the image path and kernel sizes
image_path = 'images/input/question_2/happy smiling dog.jpg'
kernels = [3, 10, 20]
# Calling the function to spatial average for 3x3, 10x10, and 20x20 neighborhoods
